    ...
    <div class="signin-content fontfamily-1">
        ...
        <p id="result-2" for="agree-term" class="label-agree-term result-2"></p>
        <div class="signin-form">
            <h2 class="form-title fontfamily-1">會員登入</h2>
            <form method="POST" class="register-form" id="login-form2">
                ...
                <div class="form-group form-button">
                    <input type="button" onclick="loginBook()" name="signin" id="signin" class="form-submit" value="登入"/>
                </div>
            </form>
